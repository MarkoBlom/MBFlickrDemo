 ...
 * Created by marko
 *
 * Note: Didn't implement view pager (swipe right) for navigating back to Album
 */
public class FullScreenActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        mData = mApp.getData().get(index);

        im = (ImageView) findViewById(R.id.full_image);
        im.setImageBitmap( mData.getMediumBitmap() );

        // Retrieve and cache the system's default "short" animation time.
        mShortAnimationDuration = getResources().getInteger(android.R.integer.config_shortAnimTime);

        //zoomImageFromThumb(im, 0);
    }
    ...
    private void zoomImageFromThumb(final ImageView thumbView, int imageResId)
    {
        ...
        final ImageView expandedImageView = (ImageView) findViewById(R.id.full_image);
        expandedImageView.setImageBitmap(mData.getMediumBitmap());
